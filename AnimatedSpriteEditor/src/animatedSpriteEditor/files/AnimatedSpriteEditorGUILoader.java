 ...
 * properly formatted XML file into a animatedSpriteEditorGUI. 
 * At the moment, it only loads window settings, but it could 
 * be extended to provide additional functionality. 
 * 
 * @author  sixin
 * @version 1.0
 */
public class AnimatedSpriteEditorGUILoader 
{
    ...
    public AnimatedSpriteEditorGUILoader() {}
     ...
     */
    public void initWindow(AnimatedSpriteEditorGUI window, String setupFileXML)
    {
        try
        {
        ...
        catch(InvalidXMLFileFormatException ixffe)
        {
            ...
            // LOG THE ERROR
            Logger.getLogger(AnimatedSpriteEditor.class.getName()).log(Level.SEVERE, null, ixffe);
